import { parseCSV, toCSV, detectColumns, downloadText } from "./csv.js";
...
async function exportState() {
  ...
  downloadText("eacl_pref_state.json", out, "application/json");
}
...
async function exportScoredCSV() {
  ...
  downloadText("EACL_2026_program_scored.csv", csvText, "text/csv");
}
